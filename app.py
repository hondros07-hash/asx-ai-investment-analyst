...
.v21286-market{padding:7px 8px 27px;min-height:158px;height:158px}.v21286-market .v21261-title{font-size:10.5px;margin-bottom:4px}.v21261-market-range{margin:0 1px 4px}.v21286-range-row{display:grid;grid-template-columns:23px minmax(0,1fr);gap:6px;align-items:center}.v21286-range-badge{width:20px;height:20px;border-radius:50%;background:#ffad00;color:#fff;display:flex;align-items:center;justify-content:center;font-size:9px;font-weight:950}.v21286-range-main{min-width:0}.v21286-range-main .v21261-k{font-size:8.4px;font-weight:850;margin-bottom:1px}.v21261-market-track{height:6px;border-radius:8px;background:#dce7f2;position:relative;margin:5px 3px 4px}.v21261-market-now{position:absolute;top:-3px;width:7px;height:12px;border-radius:5px;background:#1638a7;transform:translateX(-50%)}.v21261-market-low{display:none}.v21261-market-high{position:absolute;right:0;top:-2px;width:6px;height:10px;border-radius:4px;background:#ff284d}.v21261-market-labels{position:relative;height:11px;font-size:7.2px;color:#7890aa}.v21261-market-labels span{position:absolute;top:0;white-space:nowrap}.v21261-market-labels span:first-child{left:0}.v21261-market-labels span:nth-child(2){left:var(--mp-pos,50%);transform:translateX(-50%);font-weight:850;color:#45688f}.v21261-market-labels span:last-child{right:0}.v21286-range-position{font-size:8px;color:#10264b;font-weight:900;margin:2px 0 4px 29px}.v21286-market .v21261-table{font-size:8px;margin-top:3px}.v21286-market .v21261-table td{height:17px;padding:2px 5px}.v21286-market .v21261-table td:first-child{color:#45688f}.v21286-market .v21261-table td:last-child{text-align:right;font-weight:900;color:#10264b}.v21261-bottom{background:#fff;border:1px solid #d8e5f2;border-radius:8px;padding:9px 12px;min-height:94px;box-sizing:border-box}.v21261-bottom-title{font-size:13px;font-weight:900;color:#086ee8;margin-bottom:7px}.v21261-stats{display:grid;grid-template-columns:repeat(4,1fr)}.v21261-stat{padding:0 9px;border-right:1px solid #dfe8f2}.v21261-stat:last-child{border-right:0}.v21261-stat .k{font-size:8px;color:#67809c;font-weight:700}.v21261-stat .v{font-size:12px;color:#10264b;font-weight:900;margin-top:2px}.v21261-scenario{font-size:9.3px;color:#29476f;line-height:1.4}.v21261-quote{display:flex;align-items:center;justify-content:center;text-align:center;font-size:10px;color:#1e5ca9;font-style:italic;font-weight:800;height:72px}[class*="st-key-v21261_nav_"]{margin-top:-27px!important;position:relative!important;z-index:3!important;border-top:1px solid #e2ebf4!important;background:#fff!important}[class*="st-key-v21261_nav_"] .stButton{display:flex!important;justify-content:flex-end!important}[class*="st-key-v21261_nav_"] .stButton>button{width:auto!important;font-size:8.5px!important;font-weight:850!important;min-height:24px!important;height:24px!important;padding:0 5px!important;border:0!important;border-radius:0!important;background:#fff!important;color:#086ee8!important;box-shadow:none!important}
        </style>""",unsafe_allow_html=True)
        ...
        if np.isfinite(_mia_num(_ccmeta.get("sharesOutstanding"))):
            _mp_shares_basis="provider reported shares outstanding"
        elif np.isfinite(_mia_num(_ccmeta.get("impliedSharesOutstanding"))):
            _mp_shares_basis="provider implied shares outstanding"
        else:
