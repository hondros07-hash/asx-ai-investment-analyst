...
def _chr_identity_logo_candidates(symbol, meta, company="", size=96):
    ...
    if dom:
        ...
        branded=[
            ...
            f"https://www.google.com/s2/favicons?domain={quote(dom)}&sz={max(128,int(size))}",
        ]
        for u in reversed(branded):
...
- Obtain legal advice on the exact Australian licensing/authorisation model before offering execution to other users.""")
    ...
    if h.empty:
        ...
        st.markdown("""<style>
        /* V21.2.6 — compact top spacing + high-quality logo presentation */
        .main .block-container{padding-top:0!important;}
        .v2121-shell{margin-top:-34px!important;background:#fff;border:1px solid #d9e5f2;border-radius:9px 9px 0 0;box-shadow:0 1px 3px rgba(16,38,75,.04);margin:0;overflow:hidden;border-bottom:0}.v2121-top{display:grid;grid-template-columns:minmax(360px,1.15fr) minmax(230px,.75fr) minmax(470px,1.15fr);align-items:center;gap:12px;padding:7px 14px;border-bottom:1px solid #e4edf7;min-height:50px}.v2121-titleline{display:flex;align-items:center;gap:8px}.v2121-cc-icon{width:22px;height:22px;display:inline-flex;flex:0 0 22px}.v2121-cc-icon svg{width:22px;height:22px;stroke:#1559d6;stroke-width:1.9;fill:none;stroke-linecap:round;stroke-linejoin:round}.v2121-cc-title{font-size:19px;font-weight:900;color:#10264b;line-height:1.05}.v2121-cc-sub{font-size:11px;color:#10264b;margin-top:4px;padding-left:30px}.v2121-sep{color:#c4d1df;margin:0 9px}.v2121-motto{text-align:center;font-size:10px;color:#647b97;white-space:nowrap;justify-self:center}.v2123-actions{display:flex;justify-content:flex-end;gap:9px;align-items:center;white-space:nowrap}.v2123-btn,.v2123-btn:link,.v2123-btn:visited,.v2123-btn:hover,.v2123-btn:active{height:34px;border:1px solid #8aa3c2;border-radius:6px;background:#fff;color:#10264b;padding:0 14px;font:800 11px Arial,sans-serif;display:inline-flex;align-items:center;justify-content:center;text-decoration:none!important;box-sizing:border-box}.v2123-btn.primary,.v2123-btn.primary:hover{background:#0969e8;border-color:#0969e8;color:#fff;min-width:145px}.v2121-company{display:grid;grid-template-columns:105px minmax(245px,1.38fr) minmax(105px,.68fr) minmax(175px,1.02fr) minmax(110px,.70fr) minmax(110px,.70fr) minmax(95px,.60fr) minmax(110px,.68fr) minmax(85px,.54fr) minmax(170px,.96fr) 105px;align-items:center;padding:8px 14px;background:#fff;border:1px solid #d9e5f2;border-top:0;border-radius:0 0 9px 9px;box-shadow:0 1px 3px rgba(16,38,75,.04);margin-bottom:7px;overflow:hidden}.v2121-logo{display:flex;align-items:center;justify-content:flex-start;padding-right:12px;min-width:0}.v2121-logo img{width:96px;max-width:96px;height:58px;max-height:58px;object-fit:contain;object-position:center;image-rendering:auto}.v2121-fallback{width:92px;height:56px;border-radius:9px;background:#eef5ff;color:#1458aa;display:flex;align-items:center;justify-content:center;font-size:23px;font-weight:900}.v2121-ident{padding-right:14px;min-width:0}.v2121-name{font-size:17px;font-weight:900;color:#10264b;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.v2121-ticker{display:inline-block;background:#edf4ff;color:#10264b;border-radius:6px;padding:4px 8px;margin-left:7px;font-size:11px;font-weight:900;vertical-align:2px}.v2121-meta,.v2121-desc{font-size:10px;color:#55708e;margin-top:4px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.v2121-desc{font-size:9px;max-width:345px}.v2121-stat{min-height:58px;border-left:1px solid #e1e9f2;padding:3px 10px;display:flex;flex-direction:column;justify-content:center;min-width:0}.v2121-k{font-size:9px;font-weight:800;color:#637b98;white-space:nowrap}.v2121-v{font-size:14px;font-weight:900;color:#10264b;margin-top:3px;white-space:nowrap}.v2121-up{color:#069a4e;font-size:10px;font-weight:900}.v2121-down{color:#d14343;font-size:10px;font-weight:900}.v2121-range{height:4px;border-radius:4px;background:#dce6f1;position:relative;margin-top:7px;width:100%}.v2121-range-dot{position:absolute;top:-3px;width:10px;height:10px;border-radius:50%;background:#0878ed;transform:translateX(-50%)}.v2121-update{padding-right:6px}.v2121-update .v2121-v{font-size:9.5px;font-weight:700;line-height:1.3;white-space:normal;overflow-wrap:normal}.v2121-live{font-size:9px;font-weight:800;white-space:nowrap;padding-left:7px}.v2121-live.live{color:#078d4c}.v2121-live.delayed{color:#9a6700}.v2121-live.provider{color:#55708e}.v2121-dot{display:inline-block;width:7px;height:7px;border-radius:50%;margin-right:5px}.v2121-live.live .v2121-dot{background:#08a45c}.v2121-live.delayed .v2121-dot{background:#d99a00}.v2121-live.provider .v2121-dot{background:#7b8ca1}
        ...
        _explicit_live=bool(_ccmeta.get("isRealtime") is True or _ccmeta.get("realtime") is True or str(_ccmeta.get("dataStatus") or "").strip().lower() in {"live","real-time","realtime"})
        if _explicit_live and (not np.isfinite(_delay) or _delay <= 0):
            ...
            _data_status="Provider data"; _data_status_cls="provider"
