...
- Obtain legal advice on the exact Australian licensing/authorisation model before offering execution to other users.""")
    ...
    if h.empty:
        ...
        /* V21.2.51 — reference-density chart geometry + exact footer row alignment. */
        .v21249-chart-legend{display:flex;align-items:center;gap:14px;height:24px;margin:0!important;padding:0!important;font-size:10px;color:#162a46;line-height:24px;white-space:nowrap;box-sizing:border-box}
        ...
        [class*="st-key-v21251_technical_"]{margin:0!important;padding:0!important;height:24px!important;display:flex!important;align-items:center!important;justify-content:flex-end!important}
        [class*="st-key-v21251_technical_"] .stButton{display:flex!important;justify-content:flex-end!important;align-items:center!important;width:100%!important;height:24px!important;margin:0!important;padding:0!important}
        [class*="st-key-v21251_technical_"] .stButton>button{background:transparent!important;border:0!important;box-shadow:none!important;color:#086ee8!important;font-size:10px!important;font-weight:900!important;padding:0!important;margin:0!important;min-height:24px!important;height:24px!important;width:auto!important;min-width:max-content!important;white-space:nowrap!important;overflow:visible!important;text-overflow:clip!important}
        [class*="st-key-v21251_technical_"] .stButton>button p{white-space:nowrap!important;overflow:visible!important;text-overflow:clip!important;margin:0!important;padding:0!important;line-height:24px!important;height:24px!important;display:flex!important;align-items:center!important}
        [class*="st-key-v21251_technical_"] .stButton>button:hover{background:transparent!important;color:#005dcc!important;border:0!important}
        ...
        with _w_chart:
            with st.container(border=True,height=_overview_widget_height,key="v21243_price_card"):
                ...
                _fig.update_layout(
                    height=264,margin=dict(l=2,r=40,t=30,b=26),xaxis_rangeslider_visible=False,
                    ...
                    yaxis=dict(side="right",gridcolor="#e8eef6",autorange=True,tickformat=_axis_updates[5],ticksuffix="",automargin=True,domain=[0.19,1.0]),
                    yaxis2=dict(side="left",showgrid=False,showticklabels=False,zeroline=False,autorange=True,anchor="x",domain=[0.0,0.13]),
                )
                ...
                _foot_legend, _foot_link = st.columns([1.72, 0.78], gap="small", vertical_alignment="center")
                with _foot_legend:
                    st.markdown(
                ...
                with _foot_link:
                    st.button(
                        ...
                        key=f"v21251_technical_{ticker}",
                        type="tertiary",
