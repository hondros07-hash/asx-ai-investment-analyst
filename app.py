...
- Obtain legal advice on the exact Australian licensing/authorisation model before offering execution to other users.""")
    ...
    if h.empty:
        ...
        st.markdown("""<style>
        .v2121-shell{background:#fff;border:1px solid #d9e5f2;border-radius:12px;box-shadow:0 1px 3px rgba(16,38,75,.04);margin:0 0 8px;overflow:hidden}.v2121-top{display:grid;grid-template-columns:minmax(360px,1.45fr) minmax(210px,.8fr) auto;align-items:center;gap:14px;padding:10px 16px;border-bottom:1px solid #e4edf7}.v2121-cc-title{font-size:22px;font-weight:900;color:#10264b;line-height:1.05}.v2121-cc-sub{font-size:11px;color:#10264b;margin-top:4px}.v2121-sep{color:#c4d1df;margin:0 9px}.v2121-motto{text-align:center;font-size:10px;color:#647b97}.v2121-company{display:grid;grid-template-columns:115px minmax(240px,1.35fr) repeat(7,minmax(82px,.62fr)) minmax(145px,.9fr) 92px;align-items:center;padding:12px 16px}.v2121-logo{display:flex;align-items:center;padding-right:15px}.v2121-logo img{max-width:100px;max-height:58px;object-fit:contain}.v2121-fallback{width:92px;height:56px;border-radius:10px;background:#eef5ff;color:#1458aa;display:flex;align-items:center;justify-content:center;font-size:24px;font-weight:900}.v2121-ident{padding-right:16px}.v2121-name{font-size:19px;font-weight:900;color:#10264b}.v2121-ticker{display:inline-block;background:#edf4ff;color:#10264b;border-radius:6px;padding:4px 8px;margin-left:7px;font-size:11px;font-weight:900}.v2121-meta,.v2121-desc{font-size:10px;color:#55708e;margin-top:5px}.v2121-desc{font-size:9px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:310px}.v2121-stat{min-height:64px;border-left:1px solid #e1e9f2;padding:3px 10px;display:flex;flex-direction:column;justify-content:center}.v2121-k{font-size:9px;font-weight:800;color:#637b98}.v2121-v{font-size:16px;font-weight:900;color:#10264b;margin-top:3px;white-space:nowrap}.v2121-up{color:#069a4e;font-size:10px;font-weight:900}.v2121-down{color:#d14343;font-size:10px;font-weight:900}.v2121-range{height:4px;border-radius:4px;background:#dce6f1;position:relative;margin-top:7px}.v2121-range-dot{position:absolute;top:-3px;width:10px;height:10px;border-radius:50%;background:#0878ed;transform:translateX(-50%)}.v2121-update .v2121-v{font-size:10px;font-weight:700;line-height:1.35}.v2121-live{font-size:9px;font-weight:800;color:#078d4c;white-space:nowrap}.v2121-dot{display:inline-block;width:7px;height:7px;border-radius:50%;background:#08a45c;margin-right:5px}
