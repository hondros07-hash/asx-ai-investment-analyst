...
- Obtain legal advice on the exact Australian licensing/authorisation model before offering execution to other users.""")
    ...
    if h.empty:
        ...
        [class*="st-key-v21255_thesis_card"] [data-testid="stVerticalBlockBorderWrapper"]{padding-bottom:8px!important;box-sizing:border-box!important}
        /* V23.5.1 — bottom-align the Thesis Scorecard navigation within its fixed-height card.
           Scope only to the outer card's direct content block; nested row markup is untouched. */
        [class*="st-key-v21255_thesis_card"] > [data-testid="stVerticalBlockBorderWrapper"] > [data-testid="stVerticalBlock"],
        [class*="st-key-v21255_thesis_card"] [data-testid="stVerticalBlockBorderWrapper"] > [data-testid="stVerticalBlock"]{
            display:flex!important;flex-direction:column!important;height:100%!important;min-height:0!important;
        }
        [class*="st-key-v21255_thesis_card"] [data-testid="stVerticalBlock"] > [data-testid="stElementContainer"]:has([class*="st-key-v21255_thesis_link_"]){
            margin-top:auto!important;flex-shrink:0!important;
        }
        [class*="st-key-v21255_thesis_link_"]{margin-top:auto!important;width:100%!important}[class*="st-key-v21255_thesis_link_"] .stButton{display:flex!important;justify-content:flex-end!important;width:100%!important}[class*="st-key-v21255_thesis_link_"] .stButton>button{background:transparent!important;border:0!important;box-shadow:none!important;color:#086ee8!important;font-size:10px!important;font-weight:900!important;padding:0!important;min-height:22px!important;height:22px!important;white-space:nowrap!important;width:auto!important;max-width:none!important;overflow:visible!important;text-overflow:clip!important}[class*="st-key-v21255_thesis_link_"] .stButton>button p{white-space:nowrap!important;overflow:visible!important;text-overflow:clip!important}[class*="st-key-v21255_thesis_link_"] .stButton>button:hover{background:transparent!important;color:#005dcc!important;border:0!important}
