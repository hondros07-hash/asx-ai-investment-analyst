...
- Obtain legal advice on the exact Australian licensing/authorisation model before offering execution to other users.""")
    ...
    if h.empty:
        ...
        /* V21.2.26 — equal-height card + dedicated lower volume band */
        ...
        with _w_chart:
            with st.container(border=True):
                ...
                _fig.update_layout(
                    height=205,margin=dict(l=2,r=30,t=48,b=24),xaxis_rangeslider_visible=False,
                    ...
                    yaxis=dict(side="right",gridcolor="#e8eef6",autorange=True,tickformat=".1f",ticksuffix="",automargin=True,domain=[0.20,1.0]),
                    yaxis2=dict(side="left",showgrid=False,showticklabels=False,zeroline=False,autorange=True,domain=[0.00,0.14],anchor="x"),
                    shapes=[dict(type="line",xref="paper",yref="paper",x0=0,x1=1,y0=0.17,y1=0.17,line=dict(color="#e8eef6",width=1))],
                )
