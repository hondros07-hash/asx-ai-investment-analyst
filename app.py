...
[class*="st-key-v21310_ann_card_"] [class*="st-key-v21310_nav_ann_"] button{width:auto!important;min-height:25px!important;height:25px!important;padding:0 2px!important;border:0!important;background:transparent!important;box-shadow:none!important;color:#0067e8!important;font-size:11px!important;font-weight:800!important;white-space:nowrap!important;}
        ...
        # V23.7.11: The Streamlit container, not a separate HTML fragment, owns
        # the border. Both the HTML content and native button are inside it.
        st.markdown("""<style>
        [class*="st-key-v23711_intelligence_card_"] {
            background:#fff!important;border:1px solid #d8e5f2!important;
            border-radius:9px!important;padding:9px 15px 10px!important;
            box-shadow:0 1px 2px rgba(15,43,84,.03)!important;
            margin-bottom:12px!important;
        }
        [class*="st-key-v23711_intelligence_card_"] .v23711-card-body {
            border:0!important;border-radius:0!important;box-shadow:none!important;
            padding:0!important;margin:0!important;background:transparent!important;
        }
        [class*="st-key-v23711_intelligence_card_"] .v2342-foot {
            flex-wrap:wrap!important;row-gap:4px!important;align-items:center!important;
            padding-bottom:0!important;
        }
        [class*="st-key-v23711_news_link_"] {
            display:flex!important;justify-content:flex-end!important;
            margin-top:-29px!important;margin-bottom:0!important;
            padding:0!important;position:relative!important;z-index:2!important;
        }
        [class*="st-key-v23711_news_link_"] button {
            width:auto!important;min-height:25px!important;height:25px!important;
            padding:0 3px!important;border:0!important;background:#fff!important;
        ...
        [class*="st-key-v23711_news_link_"] button:hover {
            color:#0c477f!important;text-decoration:underline!important;
        }
        @media(max-width:900px) {
            [class*="st-key-v23711_news_link_"] {margin-top:0!important}
        }
        </style>""",unsafe_allow_html=True)
        with st.container(key=f"v23711_intelligence_card_{ticker}"):
            st.markdown(f"""<div class="v2342-card v23711-card-body">
            ...
            with st.container(key=f"v23711_news_link_{ticker}"):
                if st.button("View News & Events →", key=f"v23711_nav_intelligence_news_{ticker}"):
