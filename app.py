...
- Obtain legal advice on the exact Australian licensing/authorisation model before offering execution to other users.""")
    ...
    if h.empty:
        ...
        # V21.2.79 — Thesis Status Monitoring Engine. Stored user thesis rules take
        ...
        st.markdown("""<style>
        .v21261-snapshot-heading{font-size:16px;font-weight:950;color:#10264b;margin:2px 0 7px}.v21261-title{font-size:11px;font-weight:900;color:#10264b;margin:0 0 6px;display:flex;align-items:center;gap:5px}.v21261-info{display:inline-flex;width:12px;height:12px;border:1px solid #9bb4cf;border-radius:50%;align-items:center;justify-content:center;font-size:8px;color:#6f8cab;font-weight:900}.v21261-card{background:#fff;border:1px solid #d8e5f2;border-radius:7px;padding:7px 9px 31px;min-height:184px;height:184px;box-sizing:border-box;overflow:hidden;position:relative}.v21261-center{text-align:center}.v21261-k{font-size:8.5px;color:#45688f;font-weight:700}.v21261-v{font-size:18px;line-height:1.05;color:#10264b;font-weight:900;margin:3px 0}.v21261-pos{color:#08a142;font-weight:900}.v21261-neg{color:#e32636;font-weight:900}.v21261-watch{color:#e89a00;font-weight:900}.v21261-muted{color:#7b91aa}.v21261-table{width:100%;border-collapse:collapse;font-size:8.2px;color:#29476f}.v21261-table td{border:1px solid #dfe8f2;padding:4px 5px;height:22px}.v21261-table td:nth-child(2){font-weight:850;color:#10264b}.v21261-table td:nth-child(3){font-weight:900;text-align:right}.v21261-row{display:grid;grid-template-columns:72px minmax(0,1fr) 65px;gap:5px;border-bottom:1px solid #dfe8f2;padding:4px 2px;font-size:8.7px;color:#29476f;line-height:1.2}.v21261-row:last-child{border-bottom:0}.v21261-row b{color:#10264b;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.v21261-r{text-align:right;color:#66809c;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.v21261-risk{background:#fff0f3;border-color:#ffd5dd;min-height:76px;height:auto;padding-bottom:8px}.v21261-opp{background:#eefaf4;border-color:#d3f0df;min-height:76px;height:auto;padding-bottom:8px}.v21261-risk .v21261-title{color:#e32636}.v21261-opp .v21261-title{color:#079447}.v21261-list{font-size:8.7px;line-height:1.25;color:#29476f;display:grid;grid-template-columns:1fr 1fr;gap:5px 8px}.v21261-dot{display:inline-flex;width:14px;height:14px;border-radius:50%;align-items:center;justify-content:center;color:#fff;font-size:9px;font-weight:900;margin-right:4px}.v21261-risk .v21261-dot{background:#ef3340}.v21261-opp .v21261-dot{background:#0aa04f}.v21261-val-grid{display:grid;grid-template-columns:repeat(3,1fr);text-align:center;margin-top:2px}.v21261-val-grid>div{border-right:1px solid #e3ebf4}.v21261-val-grid>div:last-child{border-right:0}.v21261-val-lbl{font-size:8px;font-weight:900}.v21261-val-num{font-size:10px;font-weight:900;color:#10264b;margin:2px 0}.v21261-range{height:8px;background:#dce7f2;border-radius:10px;position:relative;margin:12px 8px 5px}.v21261-range i{position:absolute;top:-4px;width:6px;height:16px;border-radius:4px;background:#086ee8}.v21261-range .bear{left:0;background:#ffb000}.v21261-range .base{left:50%}.v21261-range .bull{right:0;background:#a9bfd5}.v21261-range-labels{display:flex;justify-content:space-between;font-size:7.5px;color:#527298}.v21261-spark{height:47px;margin:5px 2px}.v21261-spark svg{width:100%;height:100%}.v21261-analyst-grid{display:grid;grid-template-columns:1fr 1.1fr;gap:7px}.v21261-analyst-dist{font-size:7.8px;color:#29476f}.v21261-analyst-dist div{display:flex;justify-content:space-between;margin:3px 0}.v21261-adot{width:7px;height:7px;border-radius:50%;display:inline-block;margin-right:5px}.v21261-market-range{margin:1px 2px 7px}.v21261-market-track{height:7px;border-radius:8px;background:#dce7f2;position:relative;margin:8px 10px 4px}.v21261-market-now{position:absolute;top:-3px;width:7px;height:13px;border-radius:5px;background:#1638a7;transform:translateX(-50%)}.v21261-market-low{position:absolute;left:0;top:-2px;width:6px;height:11px;border-radius:4px;background:#ffad00}.v21261-market-high{position:absolute;right:0;top:-2px;width:6px;height:11px;border-radius:4px;background:#ff284d}.v21261-market-labels{display:flex;justify-content:space-between;font-size:7.3px;color:#7890aa}.v21261-bottom{background:#fff;border:1px solid #d8e5f2;border-radius:8px;padding:9px 12px;min-height:94px;box-sizing:border-box}.v21261-bottom-title{font-size:13px;font-weight:900;color:#086ee8;margin-bottom:7px}.v21261-stats{display:grid;grid-template-columns:repeat(4,1fr)}.v21261-stat{padding:0 9px;border-right:1px solid #dfe8f2}.v21261-stat:last-child{border-right:0}.v21261-stat .k{font-size:8px;color:#67809c;font-weight:700}.v21261-stat .v{font-size:12px;color:#10264b;font-weight:900;margin-top:2px}.v21261-scenario{font-size:9.3px;color:#29476f;line-height:1.4}.v21261-quote{display:flex;align-items:center;justify-content:center;text-align:center;font-size:10px;color:#1e5ca9;font-style:italic;font-weight:800;height:72px}[class*="st-key-v21261_nav_"]{margin-top:-31px!important;position:relative!important;z-index:3!important}[class*="st-key-v21261_nav_"] .stButton>button{font-size:8.5px!important;font-weight:850!important;min-height:26px!important;height:26px!important;padding:0 3px!important;border:0!important;border-top:1px solid #e2ebf4!important;border-radius:0!important;background:#fff!important;color:#086ee8!important;box-shadow:none!important}
        </style>""",unsafe_allow_html=True)
        ...
        with _w2:
            ...
            st.markdown(f'<div class="v21261-card" title="Chrímata model forecast. Target and positive-return frequency are model outputs, not analyst targets or price promises."><div class="v21261-title">Forecasts (Model) {_info}</div><div class="v21261-center"><div class="v21261-k">12 Month Target</div><div class="v21261-v">{display_price(_f_target,ticker) if np.isfinite(_f_target) else "—"}</div><div class="{"v21261-pos" if np.isfinite(_ccf12) and _ccf12>=0 else "v21261-neg" if np.isfinite(_ccf12) else "v21261-muted"}">{f"{_ccf12:+.1%}" if np.isfinite(_ccf12) else "Forecast unavailable"}</div><div class="v21261-spark"><svg viewBox="0 0 270 42" preserveAspectRatio="none"><polyline points="{_sparkpts}" fill="none" stroke="#086ee8" stroke-width="2"/><polygon points="10,36 {_sparkpts.split(" ",1)[1]} 260,42 10,42" fill="#d9ebfb" opacity=".8"/></svg></div><div class="v21261-k">Prob. positive return: {f"{_f_prob:.0%}" if np.isfinite(_f_prob) else "—"}</div></div></div>',unsafe_allow_html=True)
        ...
        with _w3:
            ...
            st.markdown(f'<div class="v21261-card" title="External analyst consensus supplied by Yahoo Finance via yfinance. Chrímata calculates target upside/downside versus the current provider price."><div class="v21261-title">Analyst Consensus {_info}</div><div class="v21261-analyst-grid"><div><div class="{_ac}" style="font-size:18px">{html.escape(_al)}</div><div class="v21261-k">{_ccanalyst.get("analysts") or "—"} analysts</div></div><div class="v21261-analyst-dist">{_dh}</div></div><div style="height:6px"></div><span class="v21261-k">Mean target</span><div class="v21261-v">{display_price(_at,ticker) if np.isfinite(_at) else "—"}</div><div class="{_ac}" style="font-size:9px">{f"{_aup:+.0%} vs current price" if np.isfinite(_aup) else "Target unavailable"}</div></div>',unsafe_allow_html=True)
        ...
        with _w5:
            ...
            _market=[("Avg Daily Volume",_ov_fmt(_ccvol)),("Short Interest",f"{_short:.1%}" if np.isfinite(_short) else "—"),("Shares Outstanding",_ov_fmt(_shares))]
            _mk="".join(f'<tr><td>{html.escape(k)}</td><td>{html.escape(v)}</td></tr>' for k,v in _market)
            st.markdown(f'<div class="v21261-card" title="Market-position data uses current price, 52-week high/low, volume, short interest and shares outstanding from the provider pipeline. Range position is calculated by Chrímata."><div class="v21261-title">Market Position {_info}</div><div class="v21261-market-range"><div class="v21261-k" style="text-align:center">52 Week Range</div><div class="v21261-market-track"><i class="v21261-market-low"></i><i class="v21261-market-now" style="left:{_rpct:.1f}%"></i><i class="v21261-market-high"></i></div><div class="v21261-market-labels"><span>{display_price(_cclo,ticker) if np.isfinite(_cclo) else "—"}</span><span>{display_price(price,ticker) if np.isfinite(price) else "—"}</span><span>{display_price(_cchi,ticker) if np.isfinite(_cchi) else "—"}</span></div><div class="v21261-k" style="text-align:center;margin-top:2px">{f"{_range_pos:.0%} of range ({_quart})" if np.isfinite(_range_pos) else "Range position unavailable"}</div></div><table class="v21261-table">{_mk}</table></div>',unsafe_allow_html=True)
        ...
        st.markdown('<div class="v21-foot">V21.2.72 · Technical Terminology Correction. Values are drawn from the selected company’s loaded provider, model and stored evidence; unsupported fields remain unavailable rather than being fabricated.</div>',unsafe_allow_html=True)
