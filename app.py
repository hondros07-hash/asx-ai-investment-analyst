...
- Obtain legal advice on the exact Australian licensing/authorisation model before offering execution to other users.""")
    ...
    if h.empty:
        ...
        /* V21.2.27 — restore chart breathing room while retaining a compact lower volume band */
        ...
        with _w_chart:
            with st.container(border=True):
                ...
                _fig.update_layout(
                    height=270,margin=dict(l=2,r=34,t=48,b=30),xaxis_rangeslider_visible=False,
                    ...
                    legend=dict(orientation="h",y=-.20,x=0,font=dict(size=9),traceorder="normal",itemsizing="constant"),
                    paper_bgcolor="white",plot_bgcolor="white",
                    xaxis=dict(gridcolor="#e8eef6",showgrid=True,autorange=True),
                    yaxis=dict(side="right",gridcolor="#e8eef6",autorange=True,tickformat=".1f",ticksuffix="",automargin=True,domain=[0.24,1.0]),
                    yaxis2=dict(side="left",showgrid=False,showticklabels=False,zeroline=False,autorange=True,domain=[0.00,0.17],anchor="x"),
                    shapes=[dict(type="line",xref="paper",yref="paper",x0=0,x1=1,y0=0.205,y1=0.205,line=dict(color="#e8eef6",width=1))],
                )
