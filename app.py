...
- Obtain legal advice on the exact Australian licensing/authorisation model before offering execution to other users.""")
    ...
    if h.empty:
        ...
        /* V23.5.1 — anchor the native Thesis Monitor navigation at the card bottom.
           The score and six evidence rows stay in normal flow; only the button wrapper
           consumes the remaining space. Keep the link a real Streamlit navigation button. */
        [class*="st-key-v21255_thesis_card"] > [data-testid="stVerticalBlockBorderWrapper"]{height:100%!important;box-sizing:border-box!important;}
        ...
        [class*="st-key-v21255_thesis_card"] [class*="st-key-v21255_thesis_link_"]{
            margin-top:auto!important;flex-shrink:0!important;padding-top:8px!important;
        }
